...
const SeventhPage = () => {
  ...
  return (
    <div>
      ...
      <h3>
        a: Reverse string programs using Strings. <br />
        b: Palindrome programs using Strings. <br />
        c: Character Count programs using Strings. <br />
        d: Replacing Characters programs using Strings. <br />
      </h3>
