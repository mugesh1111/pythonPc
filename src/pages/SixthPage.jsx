...
const SixthPage = () => {
  ...
  return (
    <div>
      ...
      <h3>
        a: Factorial using Functions. <br />
        b: two Largest numbers in a list programs using Functions. <br />
        c: Area of shape programs using Functions. <br />
      </h3>
