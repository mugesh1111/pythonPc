...
const EleventhPage = () => {
  const files = serveFiles[11]; // EX.NO:11 files
  ...
  return (
    <div>
      ...
      <h3>
        a: Hello World using Pygame. <br />
        b: Displaying an image using Pygame. <br />
        c: Detecting key press and release using Pygame. <br />
      </h3>
